...
gulp.task('quizz', function () {
  return gulp.src('src/quizz/**/*')
        .pipe(gulp.dest(path.join(config.dest, 'quizz')));
});
...
gulp.task('fonts', function() {
  return gulp.src('src/ressources/fonts/**/*')
...
gulp.task('build', function(done) {
  var tasks = ['html', 'fonts','quizz', 'images', 'less', 'js'];
