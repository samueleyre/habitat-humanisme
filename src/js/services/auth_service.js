...
.factory('AuthenticationService',
    ...
    function (Base64, $http, $cookieStore, $rootScope, $timeout, $location) {
        ...
        service.confirm_code = function (code, callback) {
              ...
              $http({
                method: 'POST',
                url: $rootScope.serverUrl+'confirm.php',
           ...
           data = Object.keys(data).map(function(k) {
            ...
            /* Use this for real authentication
             ...
             console.log(data + "sent to "+ $rootScope.serverUrl+"authenticate.php")
                ...
                $http({
                    method: 'POST',
                    url: $rootScope.serverUrl+'authenticate.php',
                    headers: {'Content-Type': 'application/x-www-form-urlencoded'},
                    data: data
                  }).then(function successCallback(response) {
        ...
        service.SetCredentials = function (id, surname, name, email, password) {
            var authdata = Base64.encode(id + ':' + surname + ':' + name + ':' + email + ':' + password);
